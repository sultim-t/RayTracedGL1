...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_DIFF_ACCUM_HISTORY_LENGTH = 26,
    FB_IMAGE_INDEX_DIFF_ACCUM_HISTORY_LENGTH_PREV = 27,
    ...
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R_AND_HISTORY_LENGTH = 35,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R_AND_HISTORY_LENGTH_PREV = 36,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G_AND_HISTORY_LENGTH = 37,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G_AND_HISTORY_LENGTH_PREV = 38,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B_AND_HISTORY_LENGTH = 39,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B_AND_HISTORY_LENGTH_PREV = 40,
    ...
    FB_IMAGE_INDEX_PING_GRADIENT = 49,
    FB_IMAGE_INDEX_PONG_GRADIENT = 50,
};
