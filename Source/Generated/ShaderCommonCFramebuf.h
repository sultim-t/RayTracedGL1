...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PING_GRADIENT = 70,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PONG_GRADIENT = 71,
    FB_IMAGE_INDEX_INDIR_PING_GRADIENT = 72,
    FB_IMAGE_INDEX_INDIR_PONG_GRADIENT = 73,
};
