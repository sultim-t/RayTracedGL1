...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_BLOOM_MIP1 = 55,
    FB_IMAGE_INDEX_BLOOM_MIP2 = 56,
    FB_IMAGE_INDEX_BLOOM_MIP3 = 57,
    FB_IMAGE_INDEX_BLOOM_MIP4 = 58,
    FB_IMAGE_INDEX_BLOOM_MIP5 = 59,
};
