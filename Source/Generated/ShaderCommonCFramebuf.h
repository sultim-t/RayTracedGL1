...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_MOTION = 9,
    FB_IMAGE_INDEX_UNFILTERED_DIRECT = 10,
    FB_IMAGE_INDEX_UNFILTERED_SPECULAR = 11,
    FB_IMAGE_INDEX_UNFILTERED_INDIRECT_S_H_R = 12,
    FB_IMAGE_INDEX_UNFILTERED_INDIRECT_S_H_G = 13,
    FB_IMAGE_INDEX_UNFILTERED_INDIRECT_S_H_B = 14,
    FB_IMAGE_INDEX_SURFACE_POSITION = 15,
    FB_IMAGE_INDEX_SURFACE_POSITION_PREV = 16,
    FB_IMAGE_INDEX_VISIBILITY_BUFFER = 17,
    FB_IMAGE_INDEX_VISIBILITY_BUFFER_PREV = 18,
    FB_IMAGE_INDEX_SECTOR_INDEX = 19,
    FB_IMAGE_INDEX_SECTOR_INDEX_PREV = 20,
