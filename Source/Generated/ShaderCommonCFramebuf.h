...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_BLOOM_MIP6 = 67,
    FB_IMAGE_INDEX_BLOOM_MIP7 = 68,
    FB_IMAGE_INDEX_BLOOM_MIP8 = 69,
    FB_IMAGE_INDEX_BLOOM_RESULT = 70,
    FB_IMAGE_INDEX_WIPE_EFFECT_SOURCE = 71,
    FB_IMAGE_INDEX_RESERVOIRS = 72,
    FB_IMAGE_INDEX_RESERVOIRS_PREV = 73,
    FB_IMAGE_INDEX_RESERVOIRS_INITIAL = 74,
    FB_IMAGE_INDEX_GRADIENT_INPUTS = 75,
    FB_IMAGE_INDEX_GRADIENT_INPUTS_PREV = 76,
    FB_IMAGE_INDEX_D_I_S_PING_GRADIENT = 77,
    FB_IMAGE_INDEX_D_I_S_PONG_GRADIENT = 78,
    FB_IMAGE_INDEX_D_I_S_GRADIENT_HISTORY = 79,
    FB_IMAGE_INDEX_GRADIENT_PREV_PIX = 80,
};
