...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_GRADIENT_SAMPLES = 62,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES_PREV = 63,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PING_GRADIENT = 64,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PONG_GRADIENT = 65,
    FB_IMAGE_INDEX_INDIR_PING_GRADIENT = 66,
    FB_IMAGE_INDEX_INDIR_PONG_GRADIENT = 67,
};
