...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_SCATTERING_HISTORY = 49,
    FB_IMAGE_INDEX_SCATTERING_HISTORY_PREV = 50,
    FB_IMAGE_INDEX_ACID_FOG_R_T = 51,
    FB_IMAGE_INDEX_ACID_FOG = 52,
    FB_IMAGE_INDEX_SCREEN_EMIS_R_T = 53,
    FB_IMAGE_INDEX_SCREEN_EMISSION = 54,
    FB_IMAGE_INDEX_BLOOM_INPUT = 55,
    ...
    FB_IMAGE_INDEX_BLOOM_MIP6 = 61,
    FB_IMAGE_INDEX_BLOOM_MIP7 = 62,
    FB_IMAGE_INDEX_BLOOM_MIP8 = 63,
    ...
    FB_IMAGE_INDEX_RESERVOIRS_INITIAL = 68,
    FB_IMAGE_INDEX_GRADIENT_INPUTS = 69,
    FB_IMAGE_INDEX_GRADIENT_INPUTS_PREV = 70,
