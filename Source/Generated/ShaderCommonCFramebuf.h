...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_SPEC_ACCUM_COLOR = 27,
    FB_IMAGE_INDEX_SPEC_ACCUM_COLOR_PREV = 28,
    FB_IMAGE_INDEX_SPEC_ACCUM_HISTORY_LENGTH = 29,
    FB_IMAGE_INDEX_SPEC_ACCUM_HISTORY_LENGTH_PREV = 30,
    FB_IMAGE_INDEX_PING_DIFF_COLOR_AND_VARIANCE = 31,
    FB_IMAGE_INDEX_PONG_DIFF_COLOR_AND_VARIANCE = 32,
