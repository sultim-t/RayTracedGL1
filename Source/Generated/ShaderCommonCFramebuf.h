...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_GRADIENT_SAMPLES = 63,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES_PREV = 64,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PING_GRADIENT = 65,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PONG_GRADIENT = 66,
    FB_IMAGE_INDEX_INDIR_PING_GRADIENT = 67,
    FB_IMAGE_INDEX_INDIR_PONG_GRADIENT = 68,
};
