...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_THROUGHPUT = 23,
    FB_IMAGE_INDEX_PRE_FINAL = 24,
    FB_IMAGE_INDEX_FINAL = 25,
    FB_IMAGE_INDEX_UPSCALED_PING = 26,
    FB_IMAGE_INDEX_UPSCALED_PONG = 27,
    FB_IMAGE_INDEX_DEPTH_DLSS = 28,
    ...
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R = 43,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R_PREV = 44,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G = 45,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G_PREV = 46,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B = 47,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B_PREV = 48,
    FB_IMAGE_INDEX_INDIR_PING_S_H_R = 49,
    FB_IMAGE_INDEX_INDIR_PING_S_H_G = 50,
    FB_IMAGE_INDEX_INDIR_PING_S_H_B = 51,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_R = 52,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_G = 53,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_B = 54,
    FB_IMAGE_INDEX_ATROUS_FILTERED_VARIANCE = 55,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES = 56,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES_PREV = 57,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PING_GRADIENT = 58,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PONG_GRADIENT = 59,
    FB_IMAGE_INDEX_INDIR_PING_GRADIENT = 60,
    FB_IMAGE_INDEX_INDIR_PONG_GRADIENT = 61,
