...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_VIEW_DIRECTION = 15,
    FB_IMAGE_INDEX_FINAL = 16,
    FB_IMAGE_INDEX_MOTION = 17,
    FB_IMAGE_INDEX_ACCUM_COLOR = 18,
    FB_IMAGE_INDEX_ACCUM_COLOR_PREV = 19,
    FB_IMAGE_INDEX_ACCUM_MOMENTS = 20,
    FB_IMAGE_INDEX_ACCUM_MOMENTS_PREV = 21,
    FB_IMAGE_INDEX_ACCUM_HISTORY_LENGTH = 22,
    FB_IMAGE_INDEX_ACCUM_HISTORY_LENGTH_PREV = 23,
    FB_IMAGE_INDEX_COLOR_HISTORY = 24,
    FB_IMAGE_INDEX_PING_COLOR_AND_VARIANCE = 25,
    FB_IMAGE_INDEX_PONG_COLOR_AND_VARIANCE = 26,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES = 27,
    FB_IMAGE_INDEX_PING_GRADIENT = 28,
    FB_IMAGE_INDEX_PONG_GRADIENT = 29,
};
