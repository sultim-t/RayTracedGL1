...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_ACID_FOG_R_T = 46,
    FB_IMAGE_INDEX_ACID_FOG = 47,
    FB_IMAGE_INDEX_SCREEN_EMIS_R_T = 48,
    FB_IMAGE_INDEX_SCREEN_EMISSION = 49,
    FB_IMAGE_INDEX_BLOOM_INPUT = 50,
    FB_IMAGE_INDEX_BLOOM_MIP1 = 51,
    FB_IMAGE_INDEX_BLOOM_MIP2 = 52,
    FB_IMAGE_INDEX_BLOOM_MIP3 = 53,
    FB_IMAGE_INDEX_BLOOM_MIP4 = 54,
    FB_IMAGE_INDEX_BLOOM_MIP5 = 55,
    FB_IMAGE_INDEX_BLOOM_MIP6 = 56,
    FB_IMAGE_INDEX_BLOOM_MIP7 = 57,
    FB_IMAGE_INDEX_BLOOM_MIP8 = 58,
    FB_IMAGE_INDEX_BLOOM_RESULT = 59,
    FB_IMAGE_INDEX_WIPE_EFFECT_SOURCE = 60,
    FB_IMAGE_INDEX_RESERVOIRS = 61,
    FB_IMAGE_INDEX_RESERVOIRS_PREV = 62,
    FB_IMAGE_INDEX_RESERVOIRS_INITIAL = 63,
    FB_IMAGE_INDEX_GRADIENT_INPUTS = 64,
    FB_IMAGE_INDEX_GRADIENT_INPUTS_PREV = 65,
    FB_IMAGE_INDEX_D_I_S_PING_GRADIENT = 66,
    FB_IMAGE_INDEX_D_I_S_PONG_GRADIENT = 67,
    FB_IMAGE_INDEX_D_I_S_GRADIENT_HISTORY = 68,
    FB_IMAGE_INDEX_GRADIENT_PREV_PIX = 69,
};
