...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_SCATTERING = 47,
    FB_IMAGE_INDEX_SCATTERING_PREV = 48,
    FB_IMAGE_INDEX_ACID_FOG_R_T = 49,
    FB_IMAGE_INDEX_ACID_FOG = 50,
    FB_IMAGE_INDEX_SCREEN_EMIS_R_T = 51,
    FB_IMAGE_INDEX_SCREEN_EMISSION = 52,
    FB_IMAGE_INDEX_BLOOM_INPUT = 53,
    ...
    FB_IMAGE_INDEX_BLOOM_MIP6 = 59,
    FB_IMAGE_INDEX_BLOOM_MIP7 = 60,
    FB_IMAGE_INDEX_BLOOM_MIP8 = 61,
    FB_IMAGE_INDEX_BLOOM_RESULT = 62,
    FB_IMAGE_INDEX_WIPE_EFFECT_SOURCE = 63,
    FB_IMAGE_INDEX_RESERVOIRS = 64,
    FB_IMAGE_INDEX_RESERVOIRS_PREV = 65,
    FB_IMAGE_INDEX_RESERVOIRS_INITIAL = 66,
    FB_IMAGE_INDEX_GRADIENT_INPUTS = 67,
    FB_IMAGE_INDEX_GRADIENT_INPUTS_PREV = 68,
    FB_IMAGE_INDEX_D_I_S_PING_GRADIENT = 69,
    FB_IMAGE_INDEX_D_I_S_PONG_GRADIENT = 70,
    FB_IMAGE_INDEX_D_I_S_GRADIENT_HISTORY = 71,
    FB_IMAGE_INDEX_GRADIENT_PREV_PIX = 72,
};
