...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_DIFF_ACCUM_COLOR = 28,
    FB_IMAGE_INDEX_DIFF_ACCUM_COLOR_PREV = 29,
    FB_IMAGE_INDEX_DIFF_ACCUM_MOMENTS = 30,
    FB_IMAGE_INDEX_DIFF_ACCUM_MOMENTS_PREV = 31,
    FB_IMAGE_INDEX_DIFF_COLOR_HISTORY = 32,
    FB_IMAGE_INDEX_DIFF_PING_COLOR_AND_VARIANCE = 33,
    FB_IMAGE_INDEX_DIFF_PONG_COLOR_AND_VARIANCE = 34,
    FB_IMAGE_INDEX_SPEC_ACCUM_COLOR = 35,
    FB_IMAGE_INDEX_SPEC_ACCUM_COLOR_PREV = 36,
    FB_IMAGE_INDEX_SPEC_PING_COLOR = 37,
    FB_IMAGE_INDEX_SPEC_PONG_COLOR = 38,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R = 39,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R_PREV = 40,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G = 41,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G_PREV = 42,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B = 43,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B_PREV = 44,
    FB_IMAGE_INDEX_INDIR_PING_S_H_R = 45,
    FB_IMAGE_INDEX_INDIR_PING_S_H_G = 46,
    FB_IMAGE_INDEX_INDIR_PING_S_H_B = 47,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_R = 48,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_G = 49,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_B = 50,
    FB_IMAGE_INDEX_ATROUS_FILTERED_VARIANCE = 51,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES = 52,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES_PREV = 53,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PING_GRADIENT = 54,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PONG_GRADIENT = 55,
    FB_IMAGE_INDEX_INDIR_PING_GRADIENT = 56,
    FB_IMAGE_INDEX_INDIR_PONG_GRADIENT = 57,
