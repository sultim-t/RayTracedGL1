...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_THROUGHPUT = 21,
    FB_IMAGE_INDEX_PRE_FINAL = 22,
    FB_IMAGE_INDEX_FINAL = 23,
    FB_IMAGE_INDEX_UPSCALED_PING = 24,
    FB_IMAGE_INDEX_UPSCALED_PONG = 25,
    FB_IMAGE_INDEX_DEPTH_DLSS = 26,
    FB_IMAGE_INDEX_MOTION_DLSS = 27,
    FB_IMAGE_INDEX_ACCUM_HISTORY_LENGTH = 28,
    FB_IMAGE_INDEX_ACCUM_HISTORY_LENGTH_PREV = 29,
    ...
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R = 41,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R_PREV = 42,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G = 43,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G_PREV = 44,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B = 45,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B_PREV = 46,
    FB_IMAGE_INDEX_INDIR_PING_S_H_R = 47,
    FB_IMAGE_INDEX_INDIR_PING_S_H_G = 48,
    FB_IMAGE_INDEX_INDIR_PING_S_H_B = 49,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_R = 50,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_G = 51,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_B = 52,
    FB_IMAGE_INDEX_ATROUS_FILTERED_VARIANCE = 53,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES = 54,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES_PREV = 55,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PING_GRADIENT = 56,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PONG_GRADIENT = 57,
    FB_IMAGE_INDEX_INDIR_PING_GRADIENT = 58,
    FB_IMAGE_INDEX_INDIR_PONG_GRADIENT = 59,
