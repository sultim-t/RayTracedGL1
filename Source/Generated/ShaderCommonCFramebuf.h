...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R = 47,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R_PREV = 48,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G = 49,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G_PREV = 50,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B = 51,
    FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B_PREV = 52,
    FB_IMAGE_INDEX_INDIR_PING_S_H_R = 53,
    FB_IMAGE_INDEX_INDIR_PING_S_H_G = 54,
    FB_IMAGE_INDEX_INDIR_PING_S_H_B = 55,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_R = 56,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_G = 57,
    FB_IMAGE_INDEX_INDIR_PONG_S_H_B = 58,
    FB_IMAGE_INDEX_ATROUS_FILTERED_VARIANCE = 59,
