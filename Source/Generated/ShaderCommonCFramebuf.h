...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_DIFF_ACCUM_COLOR = 22,
    FB_IMAGE_INDEX_DIFF_ACCUM_COLOR_PREV = 23,
    FB_IMAGE_INDEX_DIFF_ACCUM_MOMENTS = 24,
    FB_IMAGE_INDEX_DIFF_ACCUM_MOMENTS_PREV = 25,
    FB_IMAGE_INDEX_DIFF_AND_INDIR_ACCUM_HISTORY_LENGTH = 26,
    FB_IMAGE_INDEX_DIFF_AND_INDIR_ACCUM_HISTORY_LENGTH_PREV = 27,
    ...
    FB_IMAGE_INDEX_SPEC_ACCUM_COLOR_AND_HISTORY_LENGTH = 31,
    FB_IMAGE_INDEX_SPEC_ACCUM_COLOR_AND_HISTORY_LENGTH_PREV = 32,
    ...
    FB_IMAGE_INDEX_GRADIENT_SAMPLES = 47,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES_PREV = 48,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PING_GRADIENT = 49,
    FB_IMAGE_INDEX_DIFF_AND_SPEC_PONG_GRADIENT = 50,
    FB_IMAGE_INDEX_INDIR_PING_GRADIENT = 51,
    FB_IMAGE_INDEX_INDIR_PONG_GRADIENT = 52,
};
