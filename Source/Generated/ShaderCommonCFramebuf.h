...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_DIFF_PING_COLOR_AND_VARIANCE = 27,
    FB_IMAGE_INDEX_DIFF_PONG_COLOR_AND_VARIANCE = 28,
    FB_IMAGE_INDEX_SPEC_ACCUM_COLOR_AND_HISTORY_LENGTH = 29,
    FB_IMAGE_INDEX_SPEC_ACCUM_COLOR_AND_HISTORY_LENGTH_PREV = 30,
    FB_IMAGE_INDEX_SPEC_PING_COLOR = 31,
    FB_IMAGE_INDEX_SPEC_PONG_COLOR = 32,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES = 33,
    FB_IMAGE_INDEX_GRADIENT_SAMPLES_PREV = 34,
    FB_IMAGE_INDEX_PING_GRADIENT = 35,
    FB_IMAGE_INDEX_PONG_GRADIENT = 36,
};
