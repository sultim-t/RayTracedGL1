...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 27, rgba32f) uniform image2D framebufSpecAccumColorAndHistoryLength;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 28, rgba32f) uniform image2D framebufSpecAccumColorAndHistoryLength_Prev;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 31, rgba32ui) uniform uimage2D framebufGradientSamples;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 32, rgba32ui) uniform uimage2D framebufGradientSamples_Prev;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 33, rgba32f) uniform image2D framebufPingGradient;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 34, rgba32f) uniform image2D framebufPongGradient;

// samplers
layout(set = DESC_SET_FRAMEBUFFERS, binding = 35) uniform sampler2D framebufAlbedo_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 36) uniform sampler2D framebufNormal_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 37) uniform sampler2D framebufNormal_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 38) uniform sampler2D framebufNormalGeometry_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 39) uniform sampler2D framebufNormalGeometry_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 40) uniform sampler2D framebufMetallicRoughness_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 41) uniform sampler2D framebufMetallicRoughness_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 42) uniform sampler2D framebufDepth_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 43) uniform sampler2D framebufDepth_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 44) uniform usampler2D framebufRandomSeed_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 45) uniform usampler2D framebufRandomSeed_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 46) uniform sampler2D framebufUnfilteredDirect_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 47) uniform sampler2D framebufUnfilteredSpecular_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 48) uniform sampler2D framebufUnfilteredIndirect_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 49) uniform sampler2D framebufSurfacePosition_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 50) uniform sampler2D framebufVisibilityBuffer_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 51) uniform sampler2D framebufVisibilityBuffer_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 52) uniform sampler2D framebufViewDirection_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 53) uniform sampler2D framebufFinal_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 54) uniform sampler2D framebufMotion_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 55) uniform sampler2D framebufDiffAccumColor_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 56) uniform sampler2D framebufDiffAccumColor_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 57) uniform sampler2D framebufDiffAccumMoments_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 58) uniform sampler2D framebufDiffAccumMoments_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 59) uniform sampler2D framebufDiffAccumHistoryLength_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 60) uniform sampler2D framebufDiffAccumHistoryLength_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 61) uniform sampler2D framebufDiffColorHistory_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 62) uniform sampler2D framebufSpecAccumColorAndHistoryLength_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 63) uniform sampler2D framebufSpecAccumColorAndHistoryLength_Prev_Sampler;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 66) uniform usampler2D framebufGradientSamples_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 67) uniform usampler2D framebufGradientSamples_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 68) uniform sampler2D framebufPingGradient_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 69) uniform sampler2D framebufPongGradient_Sampler;
