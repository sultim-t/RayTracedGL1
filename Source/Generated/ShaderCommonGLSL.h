...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 81) uniform sampler2D framebufDepth_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 82) uniform sampler2D framebufDepth_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 83) uniform usampler2D framebufRandomSeed_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 84) uniform usampler2D framebufRandomSeed_Prev_Sampler;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 95) uniform usampler2D framebufSectorIndex_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 96) uniform usampler2D framebufSectorIndex_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 97) uniform sampler2D framebufViewDirection_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 98) uniform sampler2D framebufViewDirection_Prev_Sampler;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 107) uniform sampler2D framebufDepthDlss_Sampler;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 135) uniform sampler2D framebufBloom_Mip1_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 136) uniform sampler2D framebufBloom_Mip2_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 137) uniform sampler2D framebufBloom_Mip3_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 138) uniform sampler2D framebufBloom_Mip4_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 139) uniform sampler2D framebufBloom_Mip5_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 140) uniform sampler2D framebufBloom_Result_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 141) uniform sampler2D framebufWipeEffectSource_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 142) uniform usampler2D framebufReservoirs_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 143) uniform usampler2D framebufReservoirs_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 144) uniform usampler2D framebufGradientSamples_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 145) uniform usampler2D framebufGradientSamples_Prev_Sampler;
