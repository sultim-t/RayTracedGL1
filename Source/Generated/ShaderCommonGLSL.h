...
#define FB_IMAGE_INDEX_THROUGHPUT 21
#define FB_IMAGE_INDEX_PRE_FINAL 22
#define FB_IMAGE_INDEX_FINAL 23
#define FB_IMAGE_INDEX_UPSCALED_PING 24
#define FB_IMAGE_INDEX_UPSCALED_PONG 25
#define FB_IMAGE_INDEX_DEPTH_DLSS 26
#define FB_IMAGE_INDEX_MOTION_DLSS 27
#define FB_IMAGE_INDEX_ACCUM_HISTORY_LENGTH 28
#define FB_IMAGE_INDEX_ACCUM_HISTORY_LENGTH_PREV 29
...
#define FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R 41
#define FB_IMAGE_INDEX_INDIR_ACCUM_S_H_R_PREV 42
#define FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G 43
#define FB_IMAGE_INDEX_INDIR_ACCUM_S_H_G_PREV 44
#define FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B 45
#define FB_IMAGE_INDEX_INDIR_ACCUM_S_H_B_PREV 46
#define FB_IMAGE_INDEX_INDIR_PING_S_H_R 47
#define FB_IMAGE_INDEX_INDIR_PING_S_H_G 48
#define FB_IMAGE_INDEX_INDIR_PING_S_H_B 49
#define FB_IMAGE_INDEX_INDIR_PONG_S_H_R 50
#define FB_IMAGE_INDEX_INDIR_PONG_S_H_G 51
#define FB_IMAGE_INDEX_INDIR_PONG_S_H_B 52
#define FB_IMAGE_INDEX_ATROUS_FILTERED_VARIANCE 53
#define FB_IMAGE_INDEX_GRADIENT_SAMPLES 54
#define FB_IMAGE_INDEX_GRADIENT_SAMPLES_PREV 55
#define FB_IMAGE_INDEX_DIFF_AND_SPEC_PING_GRADIENT 56
#define FB_IMAGE_INDEX_DIFF_AND_SPEC_PONG_GRADIENT 57
#define FB_IMAGE_INDEX_INDIR_PING_GRADIENT 58
#define FB_IMAGE_INDEX_INDIR_PONG_GRADIENT 59
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 21, rgba16f) uniform image2D framebufThroughput;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 22, r11f_g11f_b10f) uniform image2D framebufPreFinal;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 23, r11f_g11f_b10f) uniform image2D framebufFinal;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 24, r11f_g11f_b10f) uniform image2D framebufUpscaledPing;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 25, r11f_g11f_b10f) uniform image2D framebufUpscaledPong;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 26, r32f) uniform image2D framebufDepthDlss;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 27, rg16f) uniform image2D framebufMotionDlss;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 28, r11f_g11f_b10f) uniform image2D framebufAccumHistoryLength;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 29, r11f_g11f_b10f) uniform image2D framebufAccumHistoryLength_Prev;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 41, rgba16f) uniform image2D framebufIndirAccumSH_R;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 42, rgba16f) uniform image2D framebufIndirAccumSH_R_Prev;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 43, rgba16f) uniform image2D framebufIndirAccumSH_G;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 44, rgba16f) uniform image2D framebufIndirAccumSH_G_Prev;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 45, rgba16f) uniform image2D framebufIndirAccumSH_B;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 46, rgba16f) uniform image2D framebufIndirAccumSH_B_Prev;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 47, rgba16f) uniform image2D framebufIndirPingSH_R;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 48, rgba16f) uniform image2D framebufIndirPingSH_G;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 49, rgba16f) uniform image2D framebufIndirPingSH_B;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 50, rgba16f) uniform image2D framebufIndirPongSH_R;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 51, rgba16f) uniform image2D framebufIndirPongSH_G;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 52, rgba16f) uniform image2D framebufIndirPongSH_B;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 53, r16f) uniform image2D framebufAtrousFilteredVariance;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 54, rgba32ui) uniform uimage2D framebufGradientSamples;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 55, rgba32ui) uniform uimage2D framebufGradientSamples_Prev;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 56, rgba16f) uniform image2D framebufDiffAndSpecPingGradient;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 57, rgba16f) uniform image2D framebufDiffAndSpecPongGradient;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 58, r16f) uniform image2D framebufIndirPingGradient;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 59, r16f) uniform image2D framebufIndirPongGradient;
...
// samplers
layout(set = DESC_SET_FRAMEBUFFERS, binding = 66) uniform sampler2D framebufAlbedo_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 67) uniform usampler2D framebufNormal_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 68) uniform usampler2D framebufNormal_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 69) uniform usampler2D framebufNormalGeometry_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 70) uniform usampler2D framebufNormalGeometry_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 71) uniform sampler2D framebufMetallicRoughness_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 72) uniform sampler2D framebufMetallicRoughness_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 73) uniform sampler2D framebufDepth_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 74) uniform sampler2D framebufDepth_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 75) uniform usampler2D framebufRandomSeed_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 76) uniform usampler2D framebufRandomSeed_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 77) uniform sampler2D framebufMotion_Sampler;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 120) uniform usampler2D framebufGradientSamples_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 121) uniform usampler2D framebufGradientSamples_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 122) uniform sampler2D framebufDiffAndSpecPingGradient_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 123) uniform sampler2D framebufDiffAndSpecPongGradient_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 124) uniform sampler2D framebufIndirPingGradient_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 125) uniform sampler2D framebufIndirPongGradient_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 126) uniform sampler2D framebufBloom_Mip1_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 127) uniform sampler2D framebufBloom_Mip2_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 128) uniform sampler2D framebufBloom_Mip3_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 129) uniform sampler2D framebufBloom_Mip4_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 130) uniform sampler2D framebufBloom_Mip5_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 131) uniform sampler2D framebufBloom_Result_Sampler;
