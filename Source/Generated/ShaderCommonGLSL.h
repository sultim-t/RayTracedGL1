...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 24, rgba8) uniform image2D framebufUpscaledPing;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 25, rgba8) uniform image2D framebufUpscaledPong;
