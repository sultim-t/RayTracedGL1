...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 26, r32f) uniform image2D framebufDiffAccumHistoryLength;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 27, r32f) uniform image2D framebufDiffAccumHistoryLength_Prev;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 31, rgba32f) uniform image2D framebufSpecAccumColorAndHistoryLength;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 32, rgba32f) uniform image2D framebufSpecAccumColorAndHistoryLength_Prev;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 35, rgba32f) uniform image2D framebufIndirAccumSH_RAndHistoryLength;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 36, rgba32f) uniform image2D framebufIndirAccumSH_RAndHistoryLength_Prev;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 37, rgba32f) uniform image2D framebufIndirAccumSH_GAndHistoryLength;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 38, rgba32f) uniform image2D framebufIndirAccumSH_GAndHistoryLength_Prev;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 39, rgba32f) uniform image2D framebufIndirAccumSH_BAndHistoryLength;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 40, rgba32f) uniform image2D framebufIndirAccumSH_BAndHistoryLength_Prev;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 49, rgba32f) uniform image2D framebufPingGradient;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 50, rgba32f) uniform image2D framebufPongGradient;

// samplers
layout(set = DESC_SET_FRAMEBUFFERS, binding = 51) uniform sampler2D framebufAlbedo_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 52) uniform sampler2D framebufNormal_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 53) uniform sampler2D framebufNormal_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 54) uniform sampler2D framebufNormalGeometry_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 55) uniform sampler2D framebufNormalGeometry_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 56) uniform sampler2D framebufMetallicRoughness_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 57) uniform sampler2D framebufMetallicRoughness_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 58) uniform sampler2D framebufDepth_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 59) uniform sampler2D framebufDepth_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 60) uniform usampler2D framebufRandomSeed_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 61) uniform usampler2D framebufRandomSeed_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 62) uniform sampler2D framebufUnfilteredDirect_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 63) uniform sampler2D framebufUnfilteredSpecular_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 64) uniform sampler2D framebufUnfilteredIndirectSH_R_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 65) uniform sampler2D framebufUnfilteredIndirectSH_G_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 66) uniform sampler2D framebufUnfilteredIndirectSH_B_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 67) uniform sampler2D framebufSurfacePosition_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 68) uniform sampler2D framebufVisibilityBuffer_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 69) uniform sampler2D framebufVisibilityBuffer_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 70) uniform sampler2D framebufViewDirection_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 71) uniform sampler2D framebufFinal_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 72) uniform sampler2D framebufMotion_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 73) uniform sampler2D framebufDiffAccumColor_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 74) uniform sampler2D framebufDiffAccumColor_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 75) uniform sampler2D framebufDiffAccumMoments_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 76) uniform sampler2D framebufDiffAccumMoments_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 77) uniform sampler2D framebufDiffAccumHistoryLength_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 78) uniform sampler2D framebufDiffAccumHistoryLength_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 79) uniform sampler2D framebufDiffColorHistory_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 80) uniform sampler2D framebufDiffPingColorAndVariance_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 81) uniform sampler2D framebufDiffPongColorAndVariance_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 82) uniform sampler2D framebufSpecAccumColorAndHistoryLength_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 83) uniform sampler2D framebufSpecAccumColorAndHistoryLength_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 84) uniform sampler2D framebufSpecPingColor_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 85) uniform sampler2D framebufSpecPongColor_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 86) uniform sampler2D framebufIndirAccumSH_RAndHistoryLength_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 87) uniform sampler2D framebufIndirAccumSH_RAndHistoryLength_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 88) uniform sampler2D framebufIndirAccumSH_GAndHistoryLength_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 89) uniform sampler2D framebufIndirAccumSH_GAndHistoryLength_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 90) uniform sampler2D framebufIndirAccumSH_BAndHistoryLength_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 91) uniform sampler2D framebufIndirAccumSH_BAndHistoryLength_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 92) uniform sampler2D framebufIndirPingSH_R_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 93) uniform sampler2D framebufIndirPingSH_G_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 94) uniform sampler2D framebufIndirPingSH_B_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 95) uniform sampler2D framebufIndirPongSH_R_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 96) uniform sampler2D framebufIndirPongSH_G_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 97) uniform sampler2D framebufIndirPongSH_B_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 98) uniform usampler2D framebufGradientSamples_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 99) uniform usampler2D framebufGradientSamples_Prev_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 100) uniform sampler2D framebufPingGradient_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 101) uniform sampler2D framebufPongGradient_Sampler;
