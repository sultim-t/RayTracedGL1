...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 70, rgba16f) uniform image2D framebufDISPingGradient;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 71, rgba16f) uniform image2D framebufDISPongGradient;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 138) uniform usampler2D framebufReservoirs_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 139) uniform usampler2D framebufReservoirs_Prev_Sampler;
