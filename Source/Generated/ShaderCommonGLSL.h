...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 26, rg32f) uniform image2D framebufDiffAndIndirAccumHistoryLength;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 27, rg32f) uniform image2D framebufDiffAndIndirAccumHistoryLength_Prev;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 79) uniform sampler2D framebufDiffAndIndirAccumHistoryLength_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 80) uniform sampler2D framebufDiffAndIndirAccumHistoryLength_Prev_Sampler;
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 84) uniform sampler2D framebufSpecAccumColorAndHistoryLength_Sampler;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 85) uniform sampler2D framebufSpecAccumColorAndHistoryLength_Prev_Sampler;
